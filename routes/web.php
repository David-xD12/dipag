...
Route::delete('/tecnicos/{id}','UserController@destroy')->name('tecnico.destroy');
...
//Route::put('/tecnicos/{user}','UserController@update_password_user')->name('tecnico.update_password_user');

Route::resource('categories',CategoryController::class)->names('categories');

Route::view('/scale','Scale')->name('scale');
