    ...
    <div class="container-fluid"> 
        <div class="col-lg-9 col-md-12">
          <h1>Actualizacion de datos</h1>
            <form class="row g-3 navbar" action="{{ route('tecnico.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="col-md-4">
      ...
      {{--           <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="workplace" name="workplace" value="{{ $user->workplace }}" >
                  </div>
                  {{-- <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="abilities" name="abilities" value="{{ $user->abilities }}" >
                  </div>
                  <div class="col-md-6">
